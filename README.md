...
const { data: families, response: raw } = await client.families.list().withResponse();
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/avilla-meal-planner-typescript/issues) with questions, bugs, or suggestions.
